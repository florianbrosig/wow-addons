...
--spell upodate seems to be okay
--problem is wasn't identying the party1 GUID on the LibGroupInSpecT-1.1 lib
--reviweing now the function to update the player list in the panel: elseif (update_type == "roster_update") then at line 1291
