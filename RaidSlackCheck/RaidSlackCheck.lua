...
rscignorezonedef={{1148,1149,1150,1151,1152,1153,1154,1155,168},{"Uldir","Uldir","Uldir","Uldir","Uldir","Uldir","Uldir","Uldir","Uldir"}}
...
if rscignorezone15==nil then
	rscignorezone15={{},{}}
	for i=1,#rscignorezonedef[1] do
		table.insert(rscignorezone15[1],rscignorezonedef[1][i])
		table.insert(rscignorezone15[2],rscignorezonedef[2][i])
	end
...
if #rscignorezone15[1]>0 then
	for ug=1,#rscignorezone15[1] do
		if rscignorezone15[1][ug]==curZone then
